...
class InfoCollectionWidget extends StatelessWidget {
  InfoCollectionWidget(this.listType);
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, InfoCollectionWidgetModel>(
      ...
      builder: (_, viewModel) =>
          InfoCollectionWidgetContent(viewModel, listType),
    );
  }
}

class InfoCollectionWidgetContent extends StatelessWidget {
  InfoCollectionWidgetContent(this.viewModel, this.listType);
