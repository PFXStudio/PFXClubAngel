...
class LoadingWidgetState extends State<LoadingWidget>
  ...
  void initState() {
    ...
    _successController = AnimationController(
      duration: LoadingWidget.successContentAnimationDuration,
      vsync: this,
    );
