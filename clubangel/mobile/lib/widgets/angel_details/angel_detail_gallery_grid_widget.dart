...
class AngelDetailGalleryGridWidget extends StatelessWidget {
  AngelDetailGalleryGridWidget(this.angel);
  final Angel angel;
...
class _Grid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView(
      ...
      children: angel.galleryImages.mapIndexed((index, image) {
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => GalleryWrapperWidget(
                  galleryItems: angel.galleryImages,
                  initialIndex: index,
                ),
              ));
        });
